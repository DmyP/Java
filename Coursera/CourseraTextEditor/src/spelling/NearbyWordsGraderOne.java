...
public class NearbyWordsGraderOne {
    public static void main(String args[]) {
        ...
        try {
            out = new PrintWriter("/Users/inna/Documents/Java/Coursera/CourseraTextEditor/grader_output/module5.part1.out");
        } catch (Exception e) {
            e.printStackTrace();
            return;
        }
        ...
        try {
            ...
            DictionaryLoader.loadDictionary(d, "/Users/inna/Documents/Java/Coursera/CourseraTextEditor/test_cases/dict.txt");
